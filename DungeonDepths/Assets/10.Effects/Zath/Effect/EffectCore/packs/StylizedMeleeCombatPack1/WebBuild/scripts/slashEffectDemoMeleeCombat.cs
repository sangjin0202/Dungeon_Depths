...
public class slashEffectDemoMeleeCombat : MonoBehaviour
{
   public int seq = 0;
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.Alpha1) && fire2 == false && fire3 == false && fire4 == false 
			|| Input.GetKeyDown(KeyCode.Alpha2) && fire2 == true && fire3 == false && fire4 == false 
			|| Input.GetKeyDown(KeyCode.Alpha3) && fire2 == false && fire3 == true && fire4 == false 
			|| Input.GetKeyDown(KeyCode.Alpha4) && fire2 == false && fire3 == false && fire4 == true)
        {
            fireEffect();
        }
        if (fired)
    ...
    public void CheckTimer()
    {
        for (int i = 0; i < chainEffectList.Length; i++)
        {
            ...
            {
                Instantiate(chainEffectList[i].Effect[meleefxVariation], chainEffectList[i].effectLocator.transform.position, chainEffectList[i].effectLocator.transform.rotation);
